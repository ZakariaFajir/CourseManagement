		...
		<div class="container forn-dlt">
			<div class="row g-3 align-items-center">
				<div class="col-auto col-lg-4">
					<label for="inputPassword6" class="col-form-label">Course
						Name :</label>
				</div>
				<div class="col-auto col-lg-8">
					<input type="text" id="inputPassord6" name="courseName"
			...
			<div class="row g-3 align-items-center">
				...
				<div class="col-auto col-lg-8">
					<input type="text" id="inputPassword6" name="duration"
						class="form-control" aria-describedby="passwordHelpInline"
						value="<c:out value="${course.duration}" />">
				</div>
			</div>

			<div class="row g-3 align-items-center">
				<div class="col-auto col-lg-4">
					<label for="inputPassword6" class="col-form-label">Category
						:</label>
				</div>
				<div class="col-auto col-lg-8">
			...
			<div class="row g-3 align-items-center">
				...
				<div class="col-auto col-lg-8">
					<input type="text" id="inputPassword6" class="form-control"
						name="fees" aria-describedby="passwordHelpInline"
						value="<c:out value="${course.fees}" />">
				</div>
			</div>
