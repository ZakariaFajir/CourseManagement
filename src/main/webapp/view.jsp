			...
			<tbody>
				<c:forEach items="${courses}" var="course">
					<tr bgcolor="#bffef4">
						...
						<td scope="col"><a
							href="?action=delete&courseId=<c:out value="${course.courseId}"/>"><i
								class="fa fa-trash" aria-hidden="true"></i></a> <a href="#"><i
								class="fa fa-eye" aria-hidden="true"></i></a> <a
							href="?action=update&courseId=<c:out value="${course.courseId}"/>"><i
